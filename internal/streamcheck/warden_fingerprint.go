...
func ComputeWardenFingerprint(size int64, poster string, usenetDate int64) string {
	if size <= 0 {
		return ""
	}
...
func WardenFingerprintFromNZB(n *nzbparser.Nzb, override Identity) string {
	identity := override
	if n == nil {
		return ComputeWardenFingerprint(identity.Size, identity.Poster, identity.UsenetDate)
	}
	if identity.Size <= 0 {
...
func WardenBackbone(host string) string {
...
func WardenRootDomain(host string) string {
