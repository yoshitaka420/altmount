...
func (m *Manager) discoverRadarrStrict(ctx context.Context, inst *model.ConfigInstance, filePath, cleanNzbName, libraryPath string) (*model.WebhookMetadata, error) {
	...
	client, _ := m.clients.GetOrCreateRadarrClient(inst.Name, inst.URL, inst.APIKey)
...
func (m *Manager) discoverSonarrStrict(ctx context.Context, inst *model.ConfigInstance, filePath, cleanNzbName, libraryPath string) (*model.WebhookMetadata, error) {
	instanceName := inst.Name
	client, _ := m.clients.GetOrCreateSonarrClient(inst.Name, inst.URL, inst.APIKey)
...
func (m *Manager) discoverLidarrStrict(ctx context.Context, inst *model.ConfigInstance, filePath, cleanNzbName, libraryPath string) (*model.WebhookMetadata, error) {
	return nil, fmt.Errorf("lidarr strict discovery not implemented")
}

func (m *Manager) discoverReadarrStrict(ctx context.Context, inst *model.ConfigInstance, filePath, cleanNzbName, libraryPath string) (*model.WebhookMetadata, error) {
